      ...
      <section className="relative mt-20 py-20 px-6 md:px-12 lg:px-20">
        ...
        <div className="relative z-10 container mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-white">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight text-green-400">
              𝙱𝚘𝚘𝚔 𝚊 𝚃𝚊𝚋𝚕𝚎
            </h2>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 w-full max-w-md mx-auto">
            <form className="space-y-5">
              <input
                ...
                className="w-full p-4 rounded-lg border border-gray-300 text-black placeholder-gray-500 focus:ring-2 focus:ring-green-500 outline-none"
                required
              />
              <input
                type="email"
              ...
              />
              <select
                className="w-full p-4 rounded-lg border border-gray-300 text-black focus:ring-2 focus:ring-green-500 outline-none"
                required
              >
              ...
              <button
                type="submit"
                className="w-full py-4 bg-black text-white font-semibold rounded-lg shadow-md hover:bg-green-500 hover:text-black transition-colors duration-300"
              >
                𝚁𝚎𝚜𝚎𝚛𝚟𝚎 𝙼𝚢 𝚃𝚊𝚋𝚕𝚎
              </button>
            </form>
